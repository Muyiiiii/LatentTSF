...
class Dataset_Electricity_Intro(Dataset):
    def __init__(self, args, root_path, flag='Intro_train', size=None,
        ...
        # init
        assert flag in ['Intro_train', 'Intro_test', 'Intro_val']
        type_map = {'Intro_train': 0, 'Intro_val': 1, 'Intro_test': 2}
    ...
    def __read_data__(self):
        ...
        # border2s = [num_train, num_train + num_vali, num_train]
    ...
    def __getitem__(self, index):
        step = self.seq_len if self.set_type == 2 else self.step
    ...
    def __len__(self):
        step = self.seq_len if self.set_type == 2 else self.step
        return (len(self.data_x) - self.seq_len - self.pred_len) // step + 1

    def inverse_transform(self, data):
        return self.scaler.inverse_transform(data)

class Dataset_ETT_hour_Intro(Dataset):
    def __init__(self, args, root_path, flag='Intro_train', size=None,
                 features='S', data_path='ETTh1.csv',
                 target='OT', scale=True, timeenc=0, freq='h', seasonal_patterns=None):
        # size [seq_len, label_len, pred_len]
    ...
    def __read_data__(self):
        ...
        border1s = [0, 12 * 30 * 24 - self.seq_len, 12 * 30 * 24 - self.seq_len]
        border2s = [12 * 30 * 24, 12 * 30 * 24 + 4 * 30 * 24, 12 * 30 * 24 + 8 * 30 * 24]
        border1 = border1s[self.set_type]
        border2 = border2s[self.set_type]
...
class Dataset_Solar(Dataset):
    def __init__(self, args, root_path, flag='train', size=None,
        ...
        # size [seq_len, label_len, pred_len]
        self.args = args
        self.step = getattr(self.args, 'step', 1)
        # info
        self.seq_len = size[0]
        self.label_len = size[1]
        self.pred_len = size[2]
